...
define('ADMIN_EMAIL', 'jonathan.ortega.aragon@gmail.com');
...
/* FOTOS LUGARES */
define('PLACES_IMAGE_FOLDER','/images/places');    //Carpeta para los lugares
 
define('DEFAULT_PLACE_IMAGE','defaul.png');      //imagen por defecto par las portadas

/* FOTOS PHOTOS */
define('PHOTOS_IMAGE_FOLDER','/images/photos');
